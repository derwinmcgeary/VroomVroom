...
public class WebViewFragment extends android.support.v4.app.Fragment {
    ...
    private NavigationSubItem mParam2;
    ...
    public static WebViewFragment newInstance(String param1, NavigationSubItem param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        htmlDisplay.loadUrl("file:///android_asset/" + mParam2.getContentId() + ".html");
        return rootView;
